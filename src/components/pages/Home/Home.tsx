    ...
    return (
        <div className="min-h-screen flex flex-col font-display bg-background-light dark:bg-background-dark text-background-dark dark:text-white overflow-x-hidden">
            ...
            <header className="sticky top-0 z-50 w-full border-b border-accent-dark/30 bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-md">
                <div className="mx-auto max-w-7xl px-4 sm:px-10 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <nav className="hidden md:flex items-center gap-8">
                            <a className="text-sm font-semibold transition-colors hover:text-primary-green" href="#about">{t('common.about')}</a>
                            <a className="text-sm font-semibold transition-colors hover:text-primary-green" href="#features">{t('common.features')}</a>
                            <a className="text-sm font-semibold transition-colors hover:text-primary-green" href="#contact">{t('common.contact')}</a>
                        </nav>
                ...
                {isMenuOpen && (
                    <div className="md:hidden bg-background-light dark:bg-background-dark border-b border-accent-dark/30 px-4 py-4 space-y-4">
                        <a className="block text-sm font-semibold" href="#about" onClick={() => setIsMenuOpen(false)}>{t('common.about')}</a>
                        <a className="block text-sm font-semibold" href="#features" onClick={() => setIsMenuOpen(false)}>{t('common.features')}</a>
                        <a className="block text-sm font-semibold" href="#contact" onClick={() => setIsMenuOpen(false)}>{t('common.contact')}</a>
                    </div>
                )}
            </header>
            ...
            <main className="flex-grow">
                {/* Hero Section */}
                <section id="about" className="relative overflow-hidden py-12 md:py-24 px-4 sm:px-10">
                        ...
                        <div className="flex flex-col-reverse gap-10 md:flex-row md:items-center md:gap-16">
                            ...
                            <div className="flex flex-1 flex-col gap-6 text-center md:text-left">
                                ...
                                <div className="flex flex-wrap items-center justify-center gap-4 md:justify-start">
                                    ...
                                    <a href="#features" className="flex h-12 min-w-[160px] items-center justify-center cursor-pointer rounded-full border border-accent-dark dark:border-white/20 bg-transparent px-6 text-base font-bold text-background-dark dark:text-white transition-all hover:bg-accent-dark/10 dark:hover:bg-white/10 active:scale-95">
                                        {t('common.learnMore')}
                                    </a>
                                </div>
                            </div>
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                            <div className="flex flex-col items-center justify-center gap-1 rounded-2xl bg-accent-dark/10 dark:bg-accent-dark p-8 text-center transition-transform hover:scale-[1.02]">
                                ...
                                <p className="text-base font-medium text-background-dark/80 dark:text-white/80">{t('landing.stats.students')}</p>
                            </div>
                            <div className="flex flex-col items-center justify-center gap-1 rounded-2xl bg-accent-dark/10 dark:bg-accent-dark p-8 text-center transition-transform hover:scale-[1.02]">
                                <p className="text-4xl font-black tracking-tight text-primary-green">12</p>
                                <p className="text-base font-medium text-background-dark/80 dark:text-white/80">{t('landing.stats.villages')}</p>
                            </div>
                            <div className="flex flex-col items-center justify-center gap-1 rounded-2xl bg-accent-dark/10 dark:bg-accent-dark p-8 text-center transition-transform hover:scale-[1.02]">
                                <p className="text-4xl font-black tracking-tight text-primary-green">5,000+</p>
                                <p className="text-base font-medium text-background-dark/80 dark:text-white/80">{t('landing.stats.lessons')}</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                            ...
                            <div className="group flex flex-col gap-4 rounded-2xl border border-accent-dark/20 dark:border-accent-dark bg-white dark:bg-accent-dark/50 p-6 transition-all hover:border-primary-green/50">
                                ...
                                <div>
                                    <h3 className="mb-2 text-xl font-bold">{t('landing.features.offlineTitle')}</h3>
                            ...
                            <div className="group flex flex-col gap-4 rounded-2xl border border-accent-dark/20 dark:border-accent-dark bg-white dark:bg-accent-dark/50 p-6 transition-all hover:border-primary-green/50">
                                ...
                                <div>
                                    <h3 className="mb-2 text-xl font-bold">{t('landing.features.multilingualTitle')}</h3>
                                    <p className="text-sm leading-relaxed text-background-dark/70 dark:text-white/60">
                            ...
                            <div className="group flex flex-col gap-4 rounded-2xl border border-accent-dark/20 dark:border-accent-dark bg-white dark:bg-accent-dark/50 p-6 transition-all hover:border-primary-green/50">
                                ...
                                <div>
                                    <h3 className="mb-2 text-xl font-bold">{t('landing.features.digitalLiteracyTitle')}</h3>
                                    <p className="text-sm leading-relaxed text-background-dark/70 dark:text-white/60">
                                        {t('landing.features.digitalLiteracyDesc')}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="mx-auto max-w-4xl overflow-hidden rounded-3xl bg-accent-dark px-6 py-16 text-center shadow-2xl sm:px-16">
                        <div className="flex flex-col items-center gap-6">
                            ...
                            <div className="mt-4 flex w-full flex-col gap-4 sm:w-auto sm:flex-row">
                                ...
                                <a href="#contact" className="flex h-12 min-w-[160px] items-center justify-center cursor-pointer rounded-full border border-white/20 bg-white/5 px-8 text-base font-bold text-white transition-all hover:bg-white/10 hover:border-white/40 active:scale-95">
            ...
            {/* Footer */}
            <footer id="contact" className="border-t border-accent-dark/30 bg-background-light dark:bg-background-dark py-12 px-4 sm:px-10">
                <div className="mx-auto max-w-7xl">
                    <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
                        ...
                        <div className="flex flex-wrap justify-center gap-8 text-sm font-medium text-background-dark/70 dark:text-white/70">
                            <a className="hover:text-primary-green transition-colors" href="#">{t('landing.footer.privacy')}</a>
                            <a className="hover:text-primary-green transition-colors" href="#">{t('landing.footer.terms')}</a>
                            <a className="hover:text-primary-green transition-colors" href="#">{t('common.support')}</a>
                        </div>
                        <div className="text-sm text-background-dark/50 dark:text-white/50">
                            © 2024 GyaanSetu. {t('landing.footer.rights')}
                        </div>
                    </div>
                </div>
            </footer>
